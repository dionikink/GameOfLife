...
class GameOfLife:
    ...
    def __init__(self, window_width, window_height, cell_size):
        ...
        self.grid_height = int(window_width / cell_size)
    ...
    def run_rules(self):
        ...
        for row in range(0, self.grid_height):
            ...
            for col in range(0, self.grid_width):
                ...
                if self.cells[row][row] == 0 and cell_sum == 3:
                    temp[row].append(1)
    ...
    def draw_grid(self):
        ...
        for row in range(0, self.grid_height):
            line_coords = [row * self.cell_size, 0,
                           row * self.cell_size, self.grid_height * self.cell_size]
        ...
        for col in range(0, self.grid_width):
            line_coords = [0, col * self.cell_size,
                           self.grid_width * self.cell_size, col * self.cell_size]
